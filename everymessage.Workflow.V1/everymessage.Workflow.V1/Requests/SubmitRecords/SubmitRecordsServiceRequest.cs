...
namespace everymessage.Workflow.V1
{
    ...
    /// </summary>
    internal class SubmitRecordsServiceRequest : WorkflowServiceRequest<SubmitRecordsResponse>
    {

        private readonly SubmitRecordsRequest _body;
        ...
        /// <inheritdoc />
        /// </summary>
        public override string MethodName { get => "records/submit"; }

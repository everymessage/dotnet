...
namespace everymessage.Workflow.V1
{
    ...
    /// </summary>
    internal class DeleteRecordsServiceRequest : WorkflowServiceRequest<DeleteRecordsResponse>
    {

        private readonly DeleteRecordsRequest _body;
        ...
        /// <inheritdoc />
        /// </summary>
        public override string MethodName { get => "records/delete"; }
